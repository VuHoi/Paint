...
namespace Paint.ViewModel
{
    class Triangle : Shape
    {
        ...
        private Geometry GenerateTriangleGeometry()
        {
            ...
            pathFigure.StartPoint = new Point(start.X + (this.Width) / 2, start.Y);
            pathFigure.IsClosed = true;
            LineSegment ls1 = new LineSegment();
            ls1.Point = new Point(start.X, start.Y + this.ActualHeight);
            LineSegment ls2 = new LineSegment();
            ls2.Point = new Point(start.X + this.Width, start.Y + this.ActualHeight);
